...
public class ConfirmationGameLayout extends Layout {
    private PopUpLayout popUpLayout;
    private BottomMenu bottomMenu;

    public ConfirmationGameLayout(BasicStage basicStage) {
        super(basicStage);
    ...
    class PopUpLayout extends BackgroundedLayout {
        ...
        public PopUpLayout(BasicStage basicStage) {
            super(basicStage);
            setFillParent(false);
            line1 = new LabelEntity("Are you sure to leave?", FontManagerMaster.nexaStyle);
    ...
    class BottomMenu extends Layout {
        ...
        public void onOk() {
            ConfirmationGameLayout.this.onOk();
        }

        public void onCancel() {
            ConfirmationGameLayout.this.onCancel();
        }
    }
}
