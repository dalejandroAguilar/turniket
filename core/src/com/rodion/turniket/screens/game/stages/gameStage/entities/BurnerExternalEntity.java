...
public class BurnerExternalEntity extends ImageEntity {
     private int i;
    private int j;

    public BurnerExternalEntity(int i, int j) {
        prepareAssets();
        this.i = i;
        this.j = j;
                    ...
                    if (Math.abs(dx) > Math.abs(dy)) {
                        if (Math.abs(dx) > threshold) {
                            if (dx > 0) {
                                ...
                                onAction(BurnerExternalEntity.this, Direction.Right);
//                                System.out.println("Right");
                            } else {
                                onUnpressed(BurnerExternalEntity.this);
                                onAction(BurnerExternalEntity.this, Direction.Left);
//                                System.out.println("Left");
                        ...
                        if (dy > 0) {
                            onUnpressed(BurnerExternalEntity.this);
                            onAction(BurnerExternalEntity.this, Direction.Up);
//                                System.out.println("Up");
                        } else {
                            onUnpressed(BurnerExternalEntity.this);
                            onAction(BurnerExternalEntity.this, Direction.Down);
